...
alias ffn='c && fastfetch --load-config ~/temp_ff_config.jsonc'
alias ffa='c && ff -c all'
alias com='nvim ~/code/commands'
alias charge='lenopow -e'
alias dont='lenopow -d'
alias un='sudo pacman -Rns'
alias in='sudo pacman -Sy'
alias perf='echo performance | sudo tee /sys/devices/system/cpu/cpu*/cpufreq/scaling_governor'
alias psave='echo powersave | sudo tee /sys/devices/system/cpu/cpu*/cpufreq/scaling_governor'
